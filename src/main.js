  ...
  this.foundItem = (input, data, mode) => {
    ...
    if (mode === "stores") {
      foundedItems = data.filter((item) => {
        if (
          item.FloorArea.toString().toLowerCase().search(input) != -1 ||
      ...
      foundedItems = data.filter((goods) => {
        if (
          ...
          goods.SupplierInfo.toString().toLowerCase().search(input) != -1 ||
          goods.MadeIn.toString().toLowerCase().search(input) != -1 ||
          goods.ProductionCompanyName.toString().toLowerCase().search(input) !=
            -1
        ) {
          return true;
        }
...
function View() {
   ...
   * @type {HTMLElement}
   */
  this.buttonCancelFormStore = document.getElementById("buttonCancelFormStore");
   ...
   * @type {HTMLElement}
   */
  this.buttonCancelFormGoods = document.getElementById("buttonCancelFormGoods");
   ...
   * @type {HTMLElement}
   */
  this.buttonSubmitFormStore = document.getElementById("buttonSubmitFormStore");
   ...
   * @type {HTMLElement}
   */
  this.buttonSubmitFormGoods = document.getElementById("buttonSubmitFormGoods");
   ...
   * @type {HTMLElement}
   */
  this.inputGoodsFormCompany = document.getElementById("inputGoodsFormCompany");
  ...
  this.renderGoodsList = (choosenStore, mode) => {
    return new Promise((resolve, reject) => {
      ...
      goodsArray.forEach((item) => {
        ...
        goodsSpecs.className = "goods__item goods__column-specs text-collaps";
        ...
        goodsOrigin.className = "goods__item goods__column-origin text-collaps";
        ...
        goodsCompany.setAttribute("title", `${item.ProductionCompanyName}`);
   ...
   */
  this.setFilterInfo = (inStock, inStorage, outOfStock) => {
    document.getElementById("infoAmount").innerHTML = `${choosenStore.length}`;
  ...
  this.validateStoreForm = () => {
    ...
    let badAddress = document.querySelector(".form-store__validate-address");
    ...
    if (!this.inputStoresFormEmail.value.length) {
      ...
      !regExpEmail.test(String(this.inputStoresFormEmail.value).toLowerCase())
    ) {
      badEmail.innerHTML = "Enter valid email";
      this.inputStoresFormEmail.style.border = "2px solid red";
      isGoodEmail = false;
    } else {
      this.inputStoresFormEmail.style.border = "1px solid rgb(95, 91, 91)";
      badEmail.innerHTML = "";
      isGoodEmail = true;
    }
    if (!this.inputStoresFormPhone.value.length) {
      ...
      this.inputStoresFormPhone.style.border = "1px solid rgb(95, 91, 91)";
      badPhone.innerHTML = "";
      isGoodPhone = true;
    }
    if (!this.inputStoresFormAddress.value.length) {
      ...
      this.inputStoresFormAddress.style.border = "1px solid rgb(95, 91, 91)";
  ...
  this.validateGoodsForm = () => {
    ...
    let badCompany = document.querySelector(".form-goods__validate-company");
    ...
    if (!this.inputGoodsFormSupplier.value.length) {
      ...
      this.inputGoodsFormSupplier.style.border = "1px solid rgb(95, 91, 91)";
    ...
    if (!this.inputGoodsFormOrigin.value.length) {
      ...
      this.inputGoodsFormOrigin.style.border = "1px solid rgb(95, 91, 91)";
      badOrigin.innerHTML = "";
      isGoodOrigin = true;
    }
    if (!this.inputGoodsFormCompany.value.length) {
      ...
      this.inputGoodsFormCompany.style.border = "1px solid rgb(95, 91, 91)";
    ...
    if (this.inputGoodsFormStatus.value == "Enter status") {
      ...
      this.inputGoodsFormStatus.style.border = "1px solid rgb(95, 91, 91)";
      badStatus.innerHTML = "";
      isGoodStatus = true;
    }
...
function Controller(view, model) {
  ...
  this.init = () => {
    ...
    view.buttonCreateStore.addEventListener("click", view.showFormCreateStore);
    ...
    view.buttonCreateGoods.addEventListener("click", view.showFormCreateGoods);
  ...
  this.processSortingGoodsList = (e) => {
    if (e.target.closest("." + view.sortButtonClassName) != null) {
      ...
      if (activeSort != null && sortButton.className.search(activeSort) == -1) {
        view.resetSearchButtons();
      }
